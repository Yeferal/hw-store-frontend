...
import { faArrowLeft, faArrowRight, faEdit, faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons';
...
@Component({
  selector: 'app-template-contain',
  standalone: true,
  imports: [FontAwesomeModule],
  templateUrl: './template-contain.component.html',
  styleUrl: './template-contain.component.scss'
})

export class TemplateContainComponent {
  iconEdit = faEdit;
  iconEye = faEye;
